...
Basemagique <- FonctionAnneePolAcquise(CA_2010_2021,"Effet","Echeance",2016,2021,"/01/01","/08/31","/09/01","/12/31")
BasePaneJuin21 <- Basemagique %>% filter(Annee >=2016)

BasePaneJuin21 <- subset(BasePaneJuin21, DATEEMISSION<"2021-07-01" )

write.csv2(BasePaneJuin21,"SACI/2021/DAR/Estimation PANE/Sources_Données_PANE_062021.csv")
